...
const UICtrl = (function () {
  const UISelectors = {
    incomeBtn: "#btn_ajout_rev",
    expenseBtn: "#btn_ajout_dep",
    description: "#title",
    amount: "#amount",
    moneyEarned: "#budget_fcfa",
    moneyAvailable: "#solde_fcfa",
    moneySpent: "#depense_fcfa",
    incomeList: "#list_revenu",
    expensesList: "#list_depense",
    incomeItem: ".income__amount",
    expenseItem: ".expense__amount",
    itemsContainer: ".liste_depensedeprev",
  };
